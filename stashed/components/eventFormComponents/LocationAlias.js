    ...
    return (
      <div>
        {this.props.placeholder &&
          <span>
            <label style={{fontSize: '13px', fontWeight: '400', marginBottom: '16px', lineHeight: '15px'}}>{this.props.placeholder}</label>
            <i style={{cursor: 'default', fontSize: '13px', verticalAlign: 'text-bottom', marginLeft: '8px', color: 'rgba(60, 58, 68, 0.3)'}} className='material-icons'>help_outline</i>
          </span>
        }
        {!this.props.placeholder &&
