      ...
      return (
        <div>
          <div style={{display: 'inline-block'}}>
            ...
            <input style={{color: 'rgba(60, 58, 68, 0.7)', width: '204px', fontSize: '13px', padding: '8px', fontWeight: '300', height: '31px', marginBottom: '16px'}} type='text' name='bookedThrough' value={this.props.bookedThrough} onChange={(e) => this.props.handleChange(e, 'bookedThrough')} />
          </div>
          <div style={{display: 'inline-block', marginLeft: '24px'}}>
            ...
            <input style={{color: 'rgba(60, 58, 68, 0.7)', width: '141px', fontSize: '13px', padding: '8px', fontWeight: '300', height: '31px', marginBottom: '16px'}} type='number' name='cost' value={this.props.cost} onChange={(e) => this.props.handleChange(e, 'cost')} />
          </div>
          <div>
            <label style={labelStyle}>
              Confirmation Number
